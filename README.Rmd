...
## Load data
men8385 <- read.dta13("men8385.dta")
...
ffl_model <- log(wage) ~ union + nonwhite + married + education + experience
rifreg <- rifreg(formula = ffl_model, 
                 data = men8385,
                 weights = weights,
                 statistic = "quantiles", 
                 bootstrap = TRUE, 
...
The results are qualitatively with slight deviations the same as in Firpo, Fortin, and Lemieux (2009a: 962-966). Possible reasons for difference 
Say that it is thus validated and ready to use.
```
