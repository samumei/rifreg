...
The following example shows how to write the RIF for the top 10 percent income share and, then, to estimate the RIF regression using this costum function. The formula for this spefic RIF can be found in Essam-Nassah & Lambert (2012) or Rios-Avila (2020).
```{r}
ffl_model2 <- wage ~ union + nonwhite + married + education + experience
