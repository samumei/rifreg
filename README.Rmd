...
Setting `bootstrap=TRUE` bootstraps standard errors by resampling from all observations. We can set number of `bootstrap_iterations` and the number of `cores`.  
